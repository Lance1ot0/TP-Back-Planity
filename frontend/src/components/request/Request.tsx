    ...
    <div className={style.container}>
      {!request ? (
        ...
        <div>
          ...
          <p>
            <span>Nom du salon :</span> {request.salonName}
          </p>
          <p>
            <span>Adresse :</span> {request.address}, {request.postalCode}{" "}
            {request.city}
          </p>
          <p>
            <span>Date d'émission:</span> {request.requestDate}
          </p>
          <p>
            <span>Status:</span> {request.requestStatus}
          </p>
        </div>
      )}
    </div>
